...
parser = argparse.ArgumentParser(description='Punctuation Restoration Bangla Inference on Text File')
...
parser.add_argument('--language', default='bn', type=str, help='language Bangla (bn) oe language_X (lan_x)')
...
def inference():
    ...
    if args.language == 'bn':
        punctuation_map[2] = '।' # In Bangla, the period sign '।' is commonly used at the end of sentences.
    else:
        punctuation_map[2] = '.' # Assume that the period sign for language_X is '.', but it could vary.
