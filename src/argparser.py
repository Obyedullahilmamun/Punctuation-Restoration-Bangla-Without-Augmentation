...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Punctuation Restoration Bangla')
    ...
    parser.add_argument('--language', default='bangla', type=str,
                        help='language, available options are bangla, language_X, language_X-bangla (for training with both)')
